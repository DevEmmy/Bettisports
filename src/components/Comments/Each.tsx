  ...
  return (
    <div className='flex gap-2 items-start py-5'>
        ...
        <div className='flex flex-col gap-2'>
            <p>From <span className='text-secondaryBlue'>Ade Williams</span> on <span className='text-secondaryBlue'>Where Will Kylian Mbappe Go Next? 7 Clubs That are in the Race.</span> <span className='text-gray-600'>[ Pending ]</span></p>
            ...
            <div className='flex divide-x gap-4 text-sm comment-action'>
