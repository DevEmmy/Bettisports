...
const Footer = () => {
    ...
    return (
        <div className='mt-20 px-5 md:px-xPadding border-t border-t-gray-300 py-10'>
            <div className='md:grid grid-cols-[4fr_2fr] gap-10'>
                <div className='md:grid grid-cols-5 gap-10'>
                    {
                        footerItems.map((item: FooterSubContent, i: number) => {
                            return (
                                <div key={i} className='flex flex-col gap-3 my-3 md:my-0'>
                ...
                <div className='bg-primary1 mt-4 md:mt-0 p-8 flex flex-col gap-3'>
            ...
            <div className='md:flex items-center justify-between pt-10 border-t border-t-gray-300'>
                <Image src="/./logo.svg" unoptimized width={0} className='object-contain h-auto w-[200px]' height={0} alt='' />

                <div className="my-2 md:my-0 md:flex">
